...
with connect_col:
    st.button('Want to connect? \n\n 🔗 Add me on LinkedIn', on_click=open_page, args=('https://www.linkedin.com/in/kaankorkmaz/',  use_container_width=True))
...
with coffee_col:
    st.button('Enjoy using LLMCostMate? \n\n ☕ Donate a Coffee', on_click=open_page, args=('https://www.buymeacoffee.com/kaankorkmaz', use_container_width=True))
